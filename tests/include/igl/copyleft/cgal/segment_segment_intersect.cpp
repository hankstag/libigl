...
TEST_CASE("segment_segment_intersect: boolean", "[igl/copyleft/cgal]")
{

  // example1: vanila intersecting case
  ...
  bool check1 = igl::copyleft::cgal::segment_segment_intersect(A1,B1,C1,D1,0);
  ...
  bool check2 = igl::copyleft::cgal::segment_segment_intersect(A2,B2,C2,D2,0);
  REQUIRE(check2 == true);
  ...
  bool check3 = igl::copyleft::cgal::segment_segment_intersect(A3,B3,C3,D3,0);
  REQUIRE(check3 == true);

  // example 3: colinear touching endpoint within (-eps, eps)
  double eps = igl::EPS<double>();
  ...
  bool check4 = igl::copyleft::cgal::segment_segment_intersect(A4,B4,C4,D4,1e-10);
  bool check5 = igl::copyleft::cgal::segment_segment_intersect(A4,B4,C4,D4,0);
  REQUIRE(check4 == true);
